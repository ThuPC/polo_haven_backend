...
import { LoginFrom } from "../../services/login/Login";
import { useRouter } from "vue-router";
import { jwtDecode } from "jwt-decode";
import { loginWithGoogleByRole } from "../../services/login/Login";
...
// --- Bắt đầu thay đổi ---
onBeforeMount(() => {
  // Thiết lập vai trò mặc định cho việc đăng nhập là NHANVIEN
  localStorage.setItem('selectedRole', 'NHANVIEN');
...
const handleLogin = async () => {
  try {
    console.log(authenticationRequest.value.sdt);
    console.log(authenticationRequest.value.matKhau);
    console.log("an canh")
    const response = await LoginFrom(authenticationRequest.value);
    console.log("an rau")
    ...
    if (token) {
      ...
      if (expiryTime < currentTime) {
        ...
        // ae dùng tạm tạm thời chỉ có role admin chưa phân quyền với nhân viên
          ...
          <div class="row">
              ...
              <div class="card card-plain">
                <div class="pb-0 card-header text-start">
                  ...
                  <div class="row px-xl-5 px-sm-4 px-3">
                    ...
                    <div class="col-3 me-auto px-1">
                      <a class="btn btn-outline-light w-100" @click="loginWithGoogle" href="javascript:;">
                        <svg width="24px" height="32px" viewBox="0 0 64 64" version="1.1">
                          <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <div class="card-body">
                  <form role="form" @submit.prevent="handleLogin">
                    <div class="mb-3">
                      <argon-input id="sdt" type="String" placeholder="Số điện thoại" name="sdt" size="lg"
                ...
                <div class="px-1 pt-0 text-center card-footer px-lg-2">
                  <p class="mx-auto mb-4 text-sm">Đăng kí tài khoản
                    <a href="javascript:;" class="text-success text-gradient font-weight-bold">Đăng kí</a>
                  </p>
                </div>
              </div>
            </div>
            <div
              ...
              <div
                ...
                <h4 class="mt-5 text-white font-weight-bolder position-relative">"Bill Gates"</h4>
                <p class="text-white position-relative">Những khách hàng không hài lòng sẽ là bài học tuyệt vời cho bạn
                </p>
              </div>
            </div>
          </div>
