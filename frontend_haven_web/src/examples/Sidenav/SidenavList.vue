    ...
    <ul class="navbar-nav">
      <li class="nav-item">
        <sidenav-item
          ...
          :navText="isRTL ? 'Bảng điều khiển' : 'Dashboard'"
        >
      ...
      <li class="nav-item">
        <sidenav-item
          ...
          :navText="isRTL ? 'Sản Phẩm' : 'Product'"
        >
          <template v-slot:icon>
      ...
      <li class="nav-item">
        <sidenav-item
          ...
          :navText="isRTL ? 'Đăng nhập' : 'Sign In'"
        >
          <template v-slot:icon>
